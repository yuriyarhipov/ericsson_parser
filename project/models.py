    ...
    def get_vendor_tree(self, network, vendor):
        ...
        if (network == 'WCDMA') and (vendor == 'Ericsson'):
            ...
            data.extend([
                ...
                {'id': 'RTNC',
                'label': 'Radio and Transport Network Configuration',
                'children': self.get_tree(network, 'WCDMA Radio and Transport Bulk', vendor)},
...
class UserSettings(models.Model):
    ...
    co_pci_color = models.TextField()
    sc_color = models.TextField()
    adj_minus_color = models.TextField()
    adj_plus_color = models.TextField()
    co_bcch_color = models.TextField()
    deleted_neighbour_color = models.TextField()
    new_neighbour_color = models.TextField()
    neighbour_color = models.TextField()
    selected_cell_color = models.TextField()

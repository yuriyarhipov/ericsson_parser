    ...
    def get_tree(self, network, file_type):
        ...
        if lic_files:
            ...
            for lic_file in lic_files:
                lic_menu.append({'id': lic_file.lower(), 'label': lic_file, 'children': ''})
        ...
        if hardware_files:
            ...
            for hardware_file in hardware_files:
                hardware_menu.append({'id': hardware_file.lower(), 'label': hardware_file, 'children': ''})

...
SECRET_KEY = '(wyh!1=xx%kg#eadh-f^37^r-is&*w09%es@^wlc)%qeg1yb41'
...
WSGI_APPLICATION = 'brightcomms.wsgi.application'
...
STATICFILES_DIRS = ['/home/arhipov/work/xml/frontend_xml/static', ]
STATIC_URL = '/static/'
